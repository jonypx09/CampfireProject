...
public class ChangePasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        oldPasswordField = (EditText) findViewById(R.id.firstNameEditText);
        ...
        changePasswordButton = (Button) findViewById(R.id.createAccountButton);
    ...
    public void obtainPasswordFields(View view){
        EditText oldPasswordField = (EditText) findViewById(R.id.firstNameEditText);
