...
-- Table to store all the matched students for a given student
CREATE TABLE matched (
    ...
    matched_with varchar(20) REFERENCES student (email) ON UPDATE CASCADE ON DELETE CASCADE,
    PRIMARY KEY (email, code, matched_with)
);
...
INSERT INTO matched VALUES ('rod@mail.com', 'CSC108H1', 'adam@mail.com');
INSERT INTO matched VALUES ('jonathan@mail.com', 'CSC207H1', 'rod@mail.com');
INSERT INTO matched VALUES ('jonathan@mail.com', 'CSC207H1', 'fullchee@mail.com');
